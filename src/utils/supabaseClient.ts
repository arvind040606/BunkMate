...
const supabaseUrl = getEnvVar('VITE_SUPABASE_URL').trim() || 'https://placeholder.supabase.co';
const supabaseAnonKey = getEnvVar('VITE_SUPABASE_ANON_KEY').trim() || 'placeholder-key';
